...
Location (decimal degrees): https://www.google.com/maps/search/?api=1&query=40.352455,-74.265793
Quality: 0
Satellites: 0
Speed: 4.26
Course: 336.57
Accuracy (HDOP): 99.99
Altitude (above sea level): 0.00
Location (decimal degrees): https://www.google.com/maps/search/?api=1&query=40.352455,-74.265793
Quality: 0
Satellites: 0
Speed: 4.26
...
void loop()
{
    ...
    if (fuGPS.read())
    {
        ...
        Serial.print("Speed: ");
        Serial.println(fuGPS.Speed);

        Serial.print("Course: ");
        Serial.println(fuGPS.Course);
